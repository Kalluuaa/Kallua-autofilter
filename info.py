...
SHORTLINK_API = environ.get('SHORTLINK_API', 'ca6482dc911d22055cf001d59fc94339eb1b4591')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mad_cinema')
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/mad_cinema')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mad_cinema')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/mad_cinema')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/mad_cinema/1')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001752226006)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mad_cinema')
